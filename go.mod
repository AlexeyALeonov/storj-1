...
replace github.com/zeebo/admission/v2 => github.com/bryanchriswhite/admission/v2 v2.0.0-20190925220216-76b521dfd3ec
...
require (
	...
	github.com/zeebo/admission/v2 v2.0.0-20180821192747-f24f2a94a40c
